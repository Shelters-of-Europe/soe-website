    ...
    <main className="flex min-h-screen flex-col items-center justify-between md:p-24 p-10 w-full">
      <div className="z-10 w-full md:max-w-8xl items-center content-center justify-between font-mono text-center sm:text-lg text-sm">
        ...
        <p className="mt-5">
          ...
          Wenn du neu bist, empfehlen wir dir, zuerst die <Link href='/'>Regeln</Link> zu lesen.<br/><br/>
          Du kannst dich aber auch direkt in das <Link href='/'>Setting</Link> einlesen, oder erst die <Link href='/'>Charaktervorlage</Link> anschauen.<br/><br/>
        </p>
      </div>
    </main>
  );
